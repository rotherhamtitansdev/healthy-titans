...
const mockContent = {
  ...
  section_4: ["section 4", "section 4 body", "section 4 body 2", "section 4 body 3", "section 4 body 4"]
};
...
describe("About Us", () => {
  test("component renders with sections and image", async () => {
    ...
    expect(await screen.findByRole("img", { name: "fruit and veg" })).toHaveAttribute("src", "fruit.jpg");
