...
const MenuHeader = (props: HeaderProps) => (
  <div className="flex flex-wrap h-[22rem]">
    <div className="mx-auto pt-[3rem] md:pt-[4rem]">
      ...
      <div className="font-quicksand font-medium text-homepageHeaderSubTitle text-sm md:text-base lg:text-xl text-center w-2/3 lg:w-[40rem] mx-auto">
        {props.body}
      </div>
    </div>
  </div>
