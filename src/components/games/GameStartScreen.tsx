...
const GameStartScreen = (props: { name: string, background: string }) => {
  ...
  return (
    <div className="font-quicksand bg-white h-full md: rounded-xl shadow-lg my-10 p-11 sm:p-0 pointer-events-auto sm:pointer-events-none" onClick={toggleGameStarted}>
