  ...
  return (
    <div className="w-full h-full">
      <div className="w-72 h-72 sm:w-96 sm:h-96 md:w-fit md:h-fit mx-auto relative">
        ...
        <div className="absolute top-1/2 left-1/2 -mt-[50px] -ml-[14px] sm:-mt-[70px] sm:-ml-[19px] md:-mt-[85px] md:-ml-[24px]">{props.getBYPPlateData[0].icon}</div>
        <div className="absolute top-1/2 left-1/2 -mt-[25px] ml-[19px] sm:-mt-[35px] sm:ml-[28px] md:-mt-[38px] md:ml-[30px]">{props.getBYPPlateData[1].icon}</div>
        <div className="absolute top-1/2 left-1/2 mt-[16px] ml-[8px] sm:mt-[21px] sm:ml-[10px] md:mt-[32px] md:ml-[14px]">{props.getBYPPlateData[2].icon}</div>
        <div className="absolute top-1/2 left-1/2 mt-[16px] -ml-[34px] sm:mt-[21px] sm:-ml-[50px] md:mt-[32px] md:-ml-[60px]">{props.getBYPPlateData[3].icon}</div>
        <div className="absolute top-1/2 left-1/2 -mt-[25px] -ml-[46px] sm:-mt-[35px] sm:-ml-[66px] md:-mt-[38px] md:-ml-[80px]">{props.getBYPPlateData[4].icon}</div>
      ...
      <div className="flex justify-center space-x-10">
        <button
          ...
          onClick={() => { setMobilePreviewScreenFlag(false); }}
        >
          Swap Food
        </button>
