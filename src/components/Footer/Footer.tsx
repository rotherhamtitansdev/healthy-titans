        ...
        >
          ...
          <div className="space-y-16 md:space-y-0 md:flex justify-between pb-5 md:justify-around w-full lg:w-7/12 px-4">
            <div className="space-y-6">
              <h6 className="font-bold mb-4 flex justify-left md:justify-start">
                About us
              </h6>
              <p className="mb-4">
              ...
              <p className="mb-4">
                <a
                  href="https://www.titans-rugby.com/"
                  className="text-[#243A73]"
                >
                  Titans Rugby
                </a>
              </p>
            ...
            <div className="space-y-6">
              ...
              <p className="mb-4">
                <a
                  href="https://endchildfoodpoverty.org/"
                  className="text-[#243A73]"
                >
                  #ENDCHILDFOODPOVERTY
                </a>
            ...
            <div className="space-y-6 justify-center md:justify-start">
              ...
              <div className="flex h-10 space-x-10 justify-left">
                <a
                  href="https://www.facebook.com/RotherhamRugby"
                ...
                <a
                  href="https://twitter.com/RotherhamRugby"
                  className="flex justify-center"
                >
