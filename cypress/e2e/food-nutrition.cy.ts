...
describe("Food & Nutrition", () => {
  ...
  it("Can view fried chicken information on mobile", () => {
    ...
    cy.get('[data-testid="details-title"]').should(
      "have.text",
      foodNutrition.friedChicken.title
    );
  ...
  it("Can view 'next' suggestions", () => {
    ...
    expect(NonCheeseDairyAndEggsItems).to.include.members(nextItems)
  })
});
